...
class Migration(migrations.Migration):
    ...
    replaces = [
        ('spring_manifest',
         '0001_initial'), ('spring_manifest', '0002_auto_20171003_1211'),
        ...
        ('spring_manifest',
         '0031_counter'), ('spring_manifest', '0032_auto_20180423_1500'),
        ...
        ('spring_manifest',
         '0038_auto_20180726_1200'), ('spring_manifest', '0039_manifesttype'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ('PAR', 'Spring Parcel'), ('PAK', 'Spring Packet'),
                            ('PAT',
                             'Spring Tracked'), ('PAP', 'Spring Signed'),
        ...
        migrations.AlterField(
            ...
            field=models.FileField(
                blank=True, null=True, upload_to='manifests'),
        ),
        migrations.CreateModel(
            name='SpringItem',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    ('unfiled', 'Unfiled'), ('in_progress', 'In Progress'),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ('T', 'Tracked'), ('U', 'Untracked'), ('S', 'Secure Mail')
                ],
                max_length=1),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.FileField(
                blank=True, null=True, upload_to='item_advice'),
        ),
        migrations.AddField(
            model_name='springmanifest',
            name='docket_file',
        ...
        migrations.RenameModel(
            old_name='SpringPackage',
            new_name='ManifestPackage',
        ),
        migrations.AlterModelOptions(
        ...
        migrations.RenameModel(
            old_name='SpringOrder',
            new_name='ManifestOrder',
        ),
        migrations.AlterModelOptions(
            name='manifestorder',
            options={
