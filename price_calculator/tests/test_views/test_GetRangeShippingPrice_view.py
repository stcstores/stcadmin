...
@pytest.fixture
def url():
    return "/price_calculator/get_range_shipping_price/"
...
@pytest.fixture
def country_uk(country_factory, exchange_rate_factory):
    country = country_factory.create(name="United Kindom", region__name="UK")
    exchange_rate_factory.create(currency=country.currency)
    return country
...
def test_uk_shipping(
    ...
    form_data["package_type"] = package_type.name
    form_data["internation_shipping"] = "Standard"
    shipping_method = shipping_method_factory.create(
