...
from channels.tasks import update_shopify_product
...
def test_update_shopify_product_gets_listing(
    ...
    update_shopify_product(listing_pk=listing_pk, update_pk=update_pk)
    mock_shopify_listing.objects.get.assert_called_once_with(pk=listing_pk)


def test_update_shopify_product_gets_update(
    mock_shopify_listing,
    mock_shopify_update,
    mock_shopify_listing_manager,
    listing_pk,
...
def test_update_shopify_product_calls_update_listing(
    mock_shopify_listing,
    mock_shopify_update,
    mock_shopify_listing_manager,
    listing_pk,
    ...
    update_shopify_product(listing_pk=listing_pk, update_pk=update_pk)
    mock_shopify_listing_manager.update_listing.assert_called_once_with(
        mock_shopify_listing.objects.get.return_value
    )


def test_update_shopify_product_sets_update_complete(
    mock_shopify_listing,
    mock_shopify_update,
    mock_shopify_listing_manager,
    listing_pk,
...
def test_update_shopify_product_handles_update_error(
    mock_shopify_listing,
    mock_shopify_update,
    mock_shopify_listing_manager,
    listing_pk,
    ...
    mock_shopify_listing_manager.update_listing.side_effect = Exception()
