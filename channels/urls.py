...
urlpatterns = [
    ...
    path(
        "update_shopify_collections/<int:pk>/",
        views.UpdateShopifyCollections.as_view(),
        name="update_shopify_collections",
    ),
    path(
    ...
    path(
        ...
        name="create_shopify_tag",
    ),
    path(
        "create_shopify_tag/<int:listing_pk>/",
        views.CreateShopifyTag.as_view(),
        name="create_shopify_tag",
    ),
]
