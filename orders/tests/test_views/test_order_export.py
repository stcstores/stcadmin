...
def test_export_contains_order(order, valid_get_response, export_rows):
    ...
    assert contents[1] == [
        ...
        f"{order.calculated_shipping_price/100:.2f}",
        order.currency.code,
...
def test_export_undispatched_order(undispatched_order, valid_get_response, export_rows):
    ...
    assert contents[1] == [
        ...
        f"{undispatched_order.calculated_shipping_price/100:.2f}",
        ...
        f"{undispatched_order.tax_GBP/100:.2f}",
