...
urlpatterns = [
    path(
        'basic_info/',
        views.NewBasicInfo.as_view(), name='basic_info'),
    path(
        'basic_info/<int:range_id>/',
        views.EditBasicInfo.as_view(), name='basic_info'),
    path(
        'product_info/',
    ...
    path(
        ...
        views.EditVariationOptions.as_view(), name='variation_options'),
    path(
        'unused_variations/',
        views.NewUnusedVariations.as_view(), name='unused_variations'),
    path(
        'unused_variations/<int:range_id>/',
        views.EditUnusedVariations.as_view(), name='unused_variations'),
    path(
        'variation_info/',
        views.NewVariationInfo.as_view(), name='variation_info'),
    path(
        'variation_info/<int:range_id>/',
        views.EditVariationInfo.as_view(), name='variation_info'),
    path(
